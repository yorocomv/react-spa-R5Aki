...
>;
export type RequiredChoiceCustomerTbRow = Pick<
  CustomersTbRow,
  'tel' | 'zip_code' | 'address1' | 'address2' | 'address3' | 'name1' | 'name2' | 'nja_city' | 'invoice_type_id'
>;
export type RequiredChoiceCustomer = Merge<
  RequiredChoiceCustomerTbRow & { setIsContinued: React.Dispatch<React.SetStateAction<boolean>> }
>;
